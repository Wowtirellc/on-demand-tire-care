    ...
    <section id="quote" className="py-20 md:py-28 bg-muted/30 border-y border-border">
      <div className="container">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <Reveal direction="left" className="lg:col-span-5 lg:sticky lg:top-24">
            <div>
          ...
          <Reveal direction="right" className="lg:col-span-7">
            <form onSubmit={onSubmit} className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-elegant space-y-5">
